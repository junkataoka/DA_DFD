...
srun python src/main.py --src_data="PU" --tar_data="PU" --src_domain=$SRC --tar_domain=$TAR --lr=0.00001 \
                        --batch_size=128 --epochs=200  --input_time_dim=65 --input_freq_dim=18 --input_channel=1 --num_classes=7 \
