...
def train_batch(model, src_train_batch, tar_train_batch, 
    ...
    tar_class_prob = F.softmax(tar_class, dim=1)
    loss_tar_ent = entropyMaxLoss(tar_class_prob)
    ...
    #Aloss_contra = (loss_src_contra + loss_tar_contra) / 2
